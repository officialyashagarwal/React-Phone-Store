          ...
          <div className='container py-5'>
            ...
            <div className='row'>
              ...
              <div className="col-10 mx-auto col-md-6 my-3 text-capitalize">
                ...
                <div>
                  <Link to='/'><ButtonContainer className='text-capitalize'>back to product</ButtonContainer></Link>
                  <ButtonContainer  className='text-capitalize' cart disabled= {inCart ? true : false} onClick={() => {value.addToCart(id); value.openModal(id)}}>
